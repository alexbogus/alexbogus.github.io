...
experience:
  ...
  - title: "Cybersecurity Director"
    ...
    location: "Valencia, España"
    description:
      - "Developing efficient strategies to protect system networking infrastructure."
      - "Defining and updating cyber security criteria and validation procedures."
      - "Managing meetings with other IT departments to fix safety problems."
    tags: ["Banking", "Strategy", "Infrastructure"]
  ...
  - title: "Cybersecurity Director / SOC Director"
    ...
    location: "Valencia, España"
    description:
      - "Oversee proper functioning of SOC 24x7x365."
      - "Design, implement and configure security solutions (Firewall, IDS/IPS, SIEM, DLP)."
      - "Management of external suppliers and SLAs."
    tags: ["SOC Management", "SLA", "SIEM"]
  ...
  - title: "Senior Cybersecurity Consultant"
    ...
    location: "Barcelona"
    description:
      - "Maintenance of regulatory framework in a large Spanish Bank."
      - "Designing security policy rules, guides and procedures."
      - "Secure SDLC process definition."
    tags: ["Consulting", "Regulatory", "Banking"]
  ...
  - title: "IT Manager"
    ...
    location: "Valencia"
    description:
      - "IT Security, processes and technological consultancy."
      - "Project management focused on IT security and telecommunications."
      - "Security in Radio Communications (RF)."
    tags: ["IT Management", "Telecom", "Project Management"]
...
skills:
  core:
    - { name: "SOC Design & Management", level: 95 }
    - { name: "Cybersecurity Strategy", level: 90 }
  ...
  technical:
    - { name: "SIEM / IDS / IPS", level: 95 }
    - { name: "Firewalls & WAF", level: 90 }
    - { name: "DLP & Antivirus", level: 85 }
    - { name: "Vulnerability Scanning", level: 85 }
    - { name: "Cloud Security", level: 80 }
    - { name: "ISO 38507 AI Governance", level: 75 }
    - { name: "Radio over IP (RoIP)", level: 90 }
  languages:
    - { name: "Español (Native)", level: 100 }
