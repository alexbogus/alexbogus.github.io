...
## Tecnologías y Medios Desplegados

### 1. Sistema de Videovigilancia y Consciencia Situacional (CCTV)
* **Infraestructura CCTV**: Despliegue en altura (mástil de 6,5 m) compuesto por **5 cámaras IP** (4 domos PTZ motorizados y 1 gran angular) con visión nocturna a color.
...
### 3. Geolocalización y Gestión de Flotas
* **Posicionamiento en Tiempo Real:** Monitorización de unidades intervinientes sobre cartografía e imágenes satelitales usando posicionamiento con tecnologías como: TETRA, LoRA, MESHTASTIC, MESHCORE, permitiendo ubicar recursos de manera precisa.

### 4. Comunicaciones (TETRA / SDS)
