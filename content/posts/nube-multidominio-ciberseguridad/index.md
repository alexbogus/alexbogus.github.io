...
En este sentido, a la luz de la ingente cantidad de amenazas emergentes, se hace indispensable incorporar la ciberseguridad por defecto (_security by default_) para operar cada uno de estos sistemas que comprenden la "combat cloud". Todas y cada una de las tecnologías incluidas en esta nube de combate deben ser analizadas individualmente y también en su conjunto, realizando análisis de riesgos.
